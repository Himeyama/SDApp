"""Embeds SDApp's own generation-parameter metadata into PNG files."""
...
def read_metadata(path: Path) -> dict[str, object] | None:
    """Read back the SDApp metadata JSON embedded by `save_with_metadata`, if present."""
